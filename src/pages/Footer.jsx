...
function Footer() {
  ...
  return (
    <div className='md:px-9 px-2 border-t border-A-writeup pt-7 pb-5 flex justify-between'>
      <div>
        <p className='md:hidden text-[14px] mb-2 text-A-writeup'>let's Connect</p>
        <p className='text-[14px] text-A-writeup'>Developer <span className='text-white font-semibold text-[14px] underline'>Ngene Arinze</span></p>
      </div>
      ...
      <div>
        <div className='flex mb-2 md:hidden w-[100px]'>
        ...
        <p className='text-[14px] text-A-writeup'>&copy; Copyright {year}</p>
      </div>
    </div>
  );
}
