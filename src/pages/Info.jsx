...
function Info() {
  ...
  class="cursor-pointer flex border-2 border-arinze-blue pl-1 pr-3 py-1 ml-3 items-center rounded-md text-arinze-blue m-auto tracking-wider shadow-xl"
>
      ...
      <div className='text-center'>
        <motion.div
          ...
          className='mt-5 md:mt-0  md:pt-14 pb-16 border-b border-A-writeup pt-[40px]'>
