      ...
      <div className='md:flex md:justify-between pl-6 pr-4 md:px-[100px]'>
        ...
        <div className='border-b mb-3 text-lg border-arinze-blue'>
          ...
          <div className='mb-5'>
              ...
              <div className='flex justify-start mb-2 items-center'><p className="text-[13px] mr-3 text-A-writeup ">Udemy Course from Angela yu.</p><a className='underline text-sm' href="https://drive.google.com/file/d/14D6v8dZ-i9tcP12t0usyyIeFwPiX_N3Y/view?usp=drive_link">Certificate</a></div>
              <ul className="text-A-writeup text-[14px]">
